...
{% toggle **How to implement SPP when you can only consider price as evaluation criteria.** %}
...
{% toggle **How to implement SPP when you can consider criteria other than price.**  %}
