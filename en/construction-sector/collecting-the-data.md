---
permalink: /construction-sector/collecting-the-data
...
<br>All contracts should include a clear description of the data that will be collected, when it will be collected and the methods that will be used. Consequences and responsibilities [in case of non-compliance](/prepare-contract-obligations) should also be included.
{% endcallout %}
...
<strong>Case study
<br></strong>[Copenhagen has established a task force](https://op.europa.eu/en/publication-detail/-/publication/47c69b3a-cfcf-11eb-ac72-01aa75ed71a1/language-en) for monitoring compliance with labor clauses of all suppliers in construction projects, and obtaining relevant data.
