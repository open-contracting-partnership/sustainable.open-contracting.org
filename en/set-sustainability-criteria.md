...
To this effect, some public authorities decide to explicitly include reference to sustainability in the subject matter. This would be the case in the example of “Tender for energy efficient laptops”, or in this [tender](https://sustainable-procurement.org/fileadmin/templates/sp_platform/lib/sp_platform_resources//tools/push_resource_file.php?uid=baf57b3f) from the University of Malta for which the subject matter was “*Internal finishing works, using environmentally friendly construction materials and products”.*
