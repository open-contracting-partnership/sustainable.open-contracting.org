...
{% toggle **What is the difference between SPP and Open SPP?** %}
...
{% toggle **How can you check whether current regulation allows for SPP implementation?** %}
...
{% toggle **How can you prioritize procurement categories?** %}
...
{% toggle **As a national authority, how can you facilitate Open SPP?** %}
...
{% toggle **What should you include in an SPP Action Plan?** %}
...
{% toggle **How can you find and engage with sustainable suppliers?** %}
...
{% toggle **What is an ecolabel and how can you use them for SPP?** %}
...
{% toggle **What is Life Cycle Costing (LCC) and how can you apply it in procurement?** %}
