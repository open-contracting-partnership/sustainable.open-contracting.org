...
### Opción 1: Asigne etiquetas a la contratación {#option-1}
...
{% table 197.86 198.87 185.86 183.87 col-header row-header caption: Opciones de uso de datos según su capacidad %}
| {default}  | {orange} **Sin código** | {yellow} **Código bajo** | {green} **Código** |
|---|---|---|---|
| **Opción 1: Asigne etiquetas a las contrataciones** | {orange} Revise manualmente los avisos de adquisición y tome una decisión sobre si es CPS o no.\nLas autoridades del mandato lanzan una bandera que destaca que una adquisición es CPS. | {yellow} Coloque una bandera de contratación CPS en los registros de contratos. | {green} Utilice el aprendizaje automático para identificar mediante programación si un aviso es CPS o no a partir de sus especificaciones.\nAplique esto retrospectivamente para aumentar el alcance del análisis. |
{% endtable %}

### Opción 2: Impulse el rendimiento de las políticas a través de alertas y notificaciones {#option-2}
...
| {default}  | {orange} **Sin código** | {yellow} **Código bajo** | {green} **Código** |
|---|---|---|---|
| **Opción 3: Analice los contratos adjudicados** | {orange} Haga seguimiento y supervise los contratos adjudicados en hojas de cálculo simples y herramientas de análisis comunes (por ejemplo, Excel).\n\nUse herramientas como Silver Eye para convertir estos datos en OCDS. | {yellow} Cree cuadros de mando que permitan el análisis de compradores, proveedores, categorías, etc.\n\nCree banderas en registros de contratos o portales para indicadores económicos clave: p. empresas o pymes propiedad de minorías. | {green} Enlace a datos de adjudicación de contratos a otras métricas, como datos de gastos, métricas de calidad de los datos del regulador (para entornos de atención médica o educación). |
{% endtable %}

### Opción 4: Previsión del impacto del contrato {#option-4}
...
### Opción 5: Solicite sugerencias de sostenibilidad {#option-5}
...
### Opción 6: Mida el uso de las certificaciones {#option-6}
...
### Opción 7: Supervise la ejecución del contrato {#option-7}
...
### Opción 8: Registre los datos del proveedor en el momento de la presentación de la oferta {#option-8}
...
### Opción 9: Cree registros de proveedores CPS {#option-9}
...
### Opción 10: Use datos nacionales o estatales {#option-10}
