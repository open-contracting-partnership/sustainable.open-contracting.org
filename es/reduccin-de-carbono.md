...
{green} | Reducir emisiones de carbono | Promover prácticas bajas en carbono en la contratación pública | Participación de propuestas que incluyan un presupuesto de carbono. | \-Número de propuestas que incluyan un presupuesto de carbono dentro de las especificaciones.-Número total de propuestas. | Contratos que incluyan un presupuesto de carbono / Número total de proponentes | Ver Opción 4 |
{green} | Reducir emisiones de carbono | Promover prácticas bajas en carbono en la contratación pública | Participación de propuestas que referencien emisiones CO2 dentro del puntaje de la propuesta (criterios de adjudicación. | \-Número de propuestas que referencien emisiones de CO2 dentro de los criterios de adjudicación.-Número total de propuestas | Propuestas que referencien emisiones CO2 / Número total de propuestas. | Ver Opción 5 |
{green} | Reducir emisiones de carbono | Reducir valor del carbono asociado con contratos públicos | Toneladas de CO2 asociadas con contratos públicos | \-CO2 estimado de bienes comprados.-Cantidad de unidades compradas. | Estimativos CO2 x cantidad de unidades | Ver Opción 4 |
{green} | Reducir emisiones de carbono | Reducir valor del carbono asociado con contratos públicos | Toneladas de CO2 asociadas con contratos públicos | \-CO2 proyectado antes de incluir especificaciones SPP-Emisiones reales luego de incluir especificaciones CPS y monitorear los resultados. | Emisiones proyectadas – emisiones reales | Ver Opción 5<br>Ver Opción 7 |
{green} | Reducir emisiones de carbono | Reducir valor del carbono asociado con contratos públicos | Contribución a Objetivos Nacionales a través de CPS | \-Concordancia con Objetivos Nacionales (p.ej. cómo la reducción de emisiones en la contratación pública contribuye al objetivo nacional (objetivos cero netos).-Adopción de tecnologías prescritas. | Concordancia proyectada con el objetivo (p rj. Alcanzará cero neto en 2030) | Ver Opción 5<br>Ver Opción 7 |
{green} | Reducir emisiones de carbono | Reducir valor del carbono asociado con contratos públicos | Número de contratos priorizados para implementación de CPS por ser contratos de altas emisiones.  | \-Contratos priorizados.-Número total de contratos . | Contratos priorizados /Número total de contratos | Ver Opción 4 |
{green} | Reducir emisiones de carbono | Promover proveedores de carbono bajo. | Participación de propuestas que referencien certificaciones ambientales dentro de las especificaciones. | \-Número de propuestas que referencien certificaciones ambientales dentro de las especificaciones.-Número total de propuestas. | Propuestas con referencia a certificaciones ambientales dentro de las especificaciones / Número total de propuestas | Ver Opción 1<br>Ver Opción 5<br>Ver Opción 6 |
{green} | Reducir emisiones de carbono | Promover proveedores de carbono bajo | Participación de propuestas que referencien certificaciones ambientales dentro del puntaje (criterios de adjudicación) | \-Número de propuestas que referencien certificaciones ambientales dentro de las especificaciones.<br>\-Número total de propuestas. | \-Número de propuestas que referencien certificaciones ambientales dentro del puntaje de la propuesta.<br>\-Número total de propuestas | \-Número de propuestas que referencien certificaciones ambientales dentro del puntaje.<br>\-Número total de propuestas |
{green} | Reducir emisiones de carbono | Promover proveedores de carbono bajo | Número de proveedores que cumplan con los criterios de carbono (p.ej. certificaciones ambientales) establecidos en los documentos de licitación. | \-Número de proveedores que cumplan con los criterios de carbono bajo.<br>\-Número total de proveedores. | Número de proveedores que cumplen con los criterios de carbono bajo / Número total de proveedores | Ver Opción 6 |
{green} | Reducir emisiones de carbono | Reducir la compra de productos con carbono intensivo. | Toneladas de CO2 asociadas con concreto utilizado en proyectos de contratación pública | \-CO2 estimado de concreto.<br>\-Toneladas de concreto compradas. | Estimativos de CO2 x toneladas de concreto. | Ver Opción 4 |
{green} | Reducir emisiones de carbono | Reducir la compra de productos con carbono intensivo. | Toneladas de CO2 asociadas con concreto utilizado en proyectos de contratación pública | \-CO2 estimado de concreto.<br>\-Toneladas de concreto compradas. | Estimativos de CO2 x toneladas de acero | Ver Opción 4 |
{% endtable %}

A través de los conocimientos adquiridos a partir de los datos, los compradores pueden usar esto para exigir reducciones de carbono en las contrataciones, mientras que los proveedores pueden usar los datos para mejorar sus propias cadenas de suministro y prácticas de trabajo en un esfuerzo por reducir las emisiones.
