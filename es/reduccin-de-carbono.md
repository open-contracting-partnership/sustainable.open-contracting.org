...
{green} | Reducir emisiones de carbono | Promover proveedores de carbono bajo | Participación de propuestas que referencien certificaciones ambientales dentro del puntaje (criterios de adjudicación) | \-Número de propuestas que referencien certificaciones ambientales dentro de las especificaciones.\n\-Número total de propuestas. | \-Número de propuestas que referencien certificaciones ambientales dentro del puntaje de la propuesta.\n\-Número total de propuestas | \-Número de propuestas que referencien certificaciones ambientales dentro del puntaje.\n\-Número total de propuestas |
{green} | Reducir emisiones de carbono | Promover proveedores de carbono bajo | Número de proveedores que cumplan con los criterios de carbono (p.ej. certificaciones ambientales) establecidos en los documentos de licitación. | \-Número de proveedores que cumplan con los criterios de carbono bajo.\n\-Número total de proveedores. | Número de proveedores que cumplen con los criterios de carbono bajo / Número total de proveedores | Ver Opción 6 |
{green} | Reducir emisiones de carbono | Reducir la compra de productos con carbono intensivo. | Toneladas de CO2 asociadas con concreto utilizado en proyectos de contratación pública | \-CO2 estimado de concreto.\n\-Toneladas de concreto compradas. | Estimativos de CO2 x toneladas de concreto. | Ver Opción 4 |
{green} | Reducir emisiones de carbono | Reducir la compra de productos con carbono intensivo. | Toneladas de CO2 asociadas con concreto utilizado en proyectos de contratación pública | \-CO2 estimado de concreto.\n\-Toneladas de concreto compradas. | Estimativos de CO2 x toneladas de acero | Ver Opción 4 |
{% endtable %}
