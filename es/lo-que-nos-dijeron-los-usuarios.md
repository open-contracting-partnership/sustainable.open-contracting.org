...
Las necesidades de los usuarios varían según la etapa del viaje de la contratación pública sostenible en la que se encuentren. Nuestras conversaciones con los usuarios reiteraron que la orientación es más útil cuando reconoce y aborda estas diferentes necesidades. Por esa razón, este conjunto de herramientas está estructurado en tres secciones. La [introducción](/introduccin) y la [sección uno](/plan)<strong> </strong>son las más útiles para quienes están al comienzo del viaje. Para aquellos que ya han hecho algunos avances, estas secciones también serán relevantes, pero encontrarán la información más práctica en [las secciones dos](/implemencin) y [tres](/datos-abiertos-y-progreso-de-medicin). Los practicantes más avanzados probablemente se centrarán en [la sección tres](/datos-abiertos-y-progreso-de-medicin).

- **La contratación ecológica es la máxima prioridad.**

La implementación de compras sostenibles incluye la consideración de factores en los tres pilares de las compras sostenibles: económico, social y ambiental. Sin embargo, la mayoría de nuestros usuarios estaban particularmente interesados en aprender más sobre el pilar ambiental.

En primer lugar, los recientes compromisos de muchos gobiernos con los objetivos de emisiones netas cero han llevado a un mayor interés en medir las emisiones de gases de efecto invernadero asociadas con las actividades del sector público y las cadenas de suministro públicas. En segundo lugar, descubrimos que ya se está trabajando mucho en los otros dos pilares, especialmente en relación con la promoción de empresas dirigidas por mujeres y las pymes (incluida [una excelente guía de OCP](https://www.open-contracting.org/es/resources/promover-el-equilibrio-de-genero-en-las-adquisiciones-publicas/)). Por último, la implementación de adquisiciones ecológicas a veces puede requerir conocimientos técnicos específicos de los que carecen los funcionarios de adquisiciones de primera línea.
