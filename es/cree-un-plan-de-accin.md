...
Cada país regula su contratación pública con sus propias y diversas leyes, reglamentos y marcos. Uno de los pasos claves al iniciar el ejercicio de CPS Abierta es la identificación de dichos marcos, y la evaluación de la de su alcance en términos de la implementación de prácticas CPS. Explicamos cómo usted puede hacer eso en la sección Establezca su entorno habilitante.
...
En la sección Priorice, explicamos cómo dicha determinación puede ser útil también como guía para el desarrollo de criterios de sostenibilidad, y promover la implementación de CPS Abierta en forma estandarizada y coherente. Una vez haya terminado este ejercicio usted puede comunicar los resultados en su Plan de Acción, incluida la siguiente información:
...
Una parte esencial de todos los Planes de Acción CPS Abierta se refiere a las metas, resultados e indicadores que se hayan fijado, junto con el sistema que se implementará para medir el progreso frente a ellos.

<div class="notion-text"></div>

Su Plan de Acción debe incluir información en relación con las metas perseguidas en la implementación de CPS Abierta, tales como la reducción de emisiones CO2 o la promoción de igualdad de género.

<div class="notion-text"></div>

Los resultados e indicadores seleccionados para medir el progreso dentro de estas actividades misionales, y la información en relación con la manera de medirlos, incluida su periodicidad, y las responsabilidades asignadas.

<div class="notion-text"></div>

Para una orientación más detallado, ver la sección sobre monitoreo y evaluación.
...
Muchas de las actividades asociadas con la implementación de CPS Abierta necesitarán la financiación del gobierno para ponerlos en práctica. El Plan de Acción debe compartir abiertamente los costos <strong>financieros estimados asociados con la implementación de las actividades que se requieren para desarrollar los mecanismos de apoyo y fortalecimiento de capacidades, lo mismo que para el monitoreo y comunicación de resultados. </strong>
...
Muchos países comienzan sus labores de acreditación de CPS Abierta en instituciones específicas, tales como entidades oficiales centrales seleccionadas, y gradualmente aumentan su alcance para incluir todos las entidades de gobierno central, las agencias autónomas, y las autoridades locales.
...
Aunque los países pueden comenzar con una selección de categorías específicas de contratación como enfoque para sus esfuerzos en CPS, que generalmente son las que resulten menos complejas, y que tengan el impacto más fuerte, esas categorías se puede aumentar para incluir las que resulten más complejos. Para mayores detalles sobre el proceso de priorización, consulte esta sección.
