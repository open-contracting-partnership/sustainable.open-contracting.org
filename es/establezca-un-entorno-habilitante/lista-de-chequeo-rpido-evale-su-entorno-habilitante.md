...
- [ ] Check that current regulation allows for procedures that include open disclosure of information or **ongoing dialogue during the procurement phase** (such as Competitive Dialogue) (see [here](/establezca-un-entorno-habilitante/metas-y-contratos-reservados) for more information).
