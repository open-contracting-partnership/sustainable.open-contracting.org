---
permalink: /establezca-mecanismos-de-apoyo
...
Tal como enfatizamos al comienzo de esta guía, los gobiernos tendrán que adquirir las cosas en maneras fundamentalmente distintas a las actuales y explorar nuevas tecnologías y soluciones con el fin de enfrentar la crisis climática. La vinculación de las partes interesadas implica el compartir de información y exploración de las soluciones que son esenciales para esta transición, dado que el gobierno por sí solo aún no sabe siempre qué comprar, ni cómo comprarlo.
...
Asimismo, usted debe planear un relacionamiento sostenido con la comunidad vendedora, con el fin de planear y explicar cómo las prácticas de contratación en las categorías prioritarias cambiarán, y cómo estimular inversiones en el mercado. Es esencial comunicar los beneficios del. Plan y fortalecer la confianza en el proceso de implementación.
