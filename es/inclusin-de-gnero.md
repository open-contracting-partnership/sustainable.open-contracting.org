...
|---|---|---|---|---|---|
{purple} | Promover la inclusión de género | Aumentar el acceso a la mujer en la contratación pública. | Participación de ofertas recibidas por empresas lideradas por mujeres. | \-Número de ofertas recibidas por empresas lideradas por mujeres.\n\-Número de ofertas recibidas. | Ofertas por empresas lideradas por mujeres / Número total de ofertas | Ver Opción 8 |
{purple} | Promover la inclusión de género | Aumentar el acceso a la mujer en la contratación pública. | Participación de ofertas recibidas por empresas lideradas por mujeres. | \-Número de contratos adjudicados a empresas lideradas por mujeres.\n\-Número total de contratos públicos. | Contratos adjudicados a empresas lideradas por mujeres / Número total de contratos | Ver Opción 8 |
{purple} | Promover la inclusión de género | Aumentar el acceso a la mujer en la contratación pública. | Participación de valor a contratos adjudicados a empresas lideradas por mujeres. | \-Valor de contratos adjudicados a empresas lideradas por mujeres.\n\-Valor total de contratos públicos  | Valor de contratos adjudicados a empresas lideradas por mujeres /Número total de contratos | Ver Opción 8 |
{purple} | Promover la inclusión de género | Aumentar el acceso a la mujer en la contratación pública. | Participación de contratos adjudicados a empresas lideradas por mujeres, por sector. | \-Número de contratos adjudicados a empresas lideradas por mujeres en sectores específicos (usando categorías de producto).\n\-Número total de contratos públicos por sector. | Contratos adjudicados a empresas lideradas por mujeres por sector / Número total de contratos por sector | Ver Opción 8 |
{purple} | Promover la inclusión de género | Aumentar el acceso a la mujer en la contratación pública. | Proporción de empresas registradas lideradas por mujeres que entregaron ofertas. | \-Número de empresas registradas lideradas por mujeres que entregaron ofertas.\n\-Número total de empresas lideradas por mujeres. | Número de empresas registradas lideradas por mujeres que entregaron ofertas / Número total de empresas lideradas por mujeres | Ver Opción 8 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública. | Promedio de la brecha salarial de género entre proveedores del sector público. | \-Suma de datos de brecha salarial entregada por proveedores (diferencia en porcentaje en ganancias entre funciones equivalentes en toda la organización)\n\-Número total de proveedores. | Suma de los datos de brecha salarial entregada por proveedores / Número total de provee4dores | Ver Opción 8\nVer Opción 10 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública. | Promedio de la brecha salarial entre proveedores del sector público por categoría de contratación (p.ej. TI, construcción, etc.) | \-Suma de datos de brecha salarial entregada por proveedores (diferencia en porcentaje en ganancias entre funciones equivalentes en toda la organización)\n\-Número total de proveedores. | Suma de datos de brecha salarial entregada por proveedores (en una categoría específica) / Número total de proveedores (en una categoría específica  | Ver Opción 8\nVer Opción 10 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública.  | Desvío de la brecha salarial para los proveedores ganadores. | \-Promedio de la brecha para la categoría del suministro.\n\-Brecha salarial de los proveedores ganadores. | Promedio de brecha salarial por categoría – brecha salarial del proveedor ganador  | Ver Opción 10 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública.  | Desvío de la brecha salarial promedio de todos los oferentes y de los proveedores ganadores. | \-Promedio de la brecha para la categoría del suministro.\n\-Brecha salarial de los proveedores ganadores. | Promedio de brecha salaria para proponentes – brecha salaria para el proveedor ganador | Ver Opción 8\nVer Opción 10 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública. | Participación de contratos adjudicados a proveedores que presenten igualdad salarial dentro de su organización. | \-Número de contratos adjudicados a proveedores que presenten igualdad salarial.\n\-Número total de contratos. | Contratos adjudicados a proveedores que presenten igualdad salarial / Número total de propuestas publicadas | Ver Opción 1\nVer Opción 10 |
{purple} | Promover la inclusión de género | Promover igualdad salarial de género a través de contratación pública. | Participación de propuestas que referencien desigualdad de género dentro del puntaje (criterios de adjudicación) | \-Número de propuestas que referencien desigualdad de género dentro del puntaje de propuestas..\n\-Número total de propuestas publicadas | Propuestas que referencien desigualdad de género / Número total de propuestas publicadas | Ver Opción 1\nVer Opción 5 |
{purple} | Promover la inclusión de género | Promover la igualdad de género en licitaciones públicas | Participación de valor que propuestas que referencien desigualdad de género dentro del puntaje (criterios de adjudicación) | \-Valor total de propuestas que referencien desigualdad de género dentro de los puntajes de propuestas.\n\-Valor total de propuestas publicadas  | Valor de propuestas que referencien desigualdad de género / Valor total de las propuestas publicadas | Ver Opción 1\nVer Opción 5 |
{purple} | Promover la inclusión de género | Promover la igualdad de género en licitaciones públicas | Participación de compradores públicos que publiquen ofertas que referencien desigualdad de enero dentro del puntaje (criterios de adjudicación) | \-Número de compradores que publican ofertas que referencian desigualdad de género en el puntaje.\n\-Número total de compradores públicos. | Número de compradores que publiquen propuestas que referencien desigualdad de género / Número total de compradores públicos | Ver Opción 1\nVer Opción 5 |
{% endtable %}
