...
Todavía estamos aprendiendo qué funciona para mejorar la sostenibilidad y permitir un cambio fundamental en la forma en que el gobierno compra bienes, obras y servicios para lograr mejores resultados sociales y ambientales, por lo que este ejercicio no debe verse como un 'te pillo' para atrapar a los contratistas y castigarlos, sino más bien como una forma de aprender, iterar y mejorar lo que funciona. Tim Cummins, presidente de la Asociación Mundial de Comercio y Contratación, analiza esto en su artículo: [Si salvar el mundo depende de los contratos, ¿es hora de darse por vencido?](https://commitmentmatters.com/2021/05/26/if-saving-the-world-depends-on-contracts-is-it-time-to-give-up/)
...
- **Certificados de acreditación** frente a los estándares de un esquema de acreditación específico, que puede incluir, por ejemplo, una etiqueta ambiental. Como se explica a lo largo de este kit de herramientas, la mayoría de los marcos habilitadores no permiten hacer referencia a esquemas de ecoetiqueta específicos sin aceptar medios de verificación distintos al certificado de ecoetiqueta. Esto incluye medios de verificación como informes de laboratorio, pruebas o documentación técnica
- Los proveedores pueden presentar **informes de laboratorio** para verificar, por ejemplo, la composición de ciertos productos, y los **informes de pruebas** pueden usarse para verificar factores como las emisiones de ruido o el uso de energía.
- La **documentación técnica** incluye, por ejemplo, informes del fabricante que pueden incluir datos relevantes sobre el rendimiento de ciertos productos.
- **Documentación de la empresa** para verificar criterios como el estatus de PYME o códigos de conducta de proveedores.

Dependiendo del tipo de contrato, podrá ser difícil recopilar toda la documentación relevante (por ejemplo, recopilar la documentación de verificación de todos los materiales utilizados en un proyecto de construcción o los residuos generados durante la duración del contrato). Para facilitar este proceso, una opción podría ser establecer registros de gestión de materiales o residuos, donde los proveedores puedan importar datos relevantes en las etapas acordadas a lo largo del contrato.
