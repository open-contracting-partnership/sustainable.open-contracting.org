...
{% callout green /assets/images/icons_D_Green6.png %}
Si una autoridad pública decide seleccionar "reducción de valores de carbono asociados con contratos públicos" como resultado, podría optar por medir el resultado de la captura de "toneladas de CO2 asociadas con los contratos públicos". Esto se calcularía multiplicando los valores estimados de CO2 de los bienes adquiridos, por el número de unidades compradas. Para una orientación adicional de sobre la visión de progreso, consultar el ejemplo de trabajo completo que aparece en la sección 3.
{% endcallout %}
