---
permalink: /relacinese-con-el-mercado
...
El nuevo contrato de la ciudad amplía el servicio de 6500 a 9300 bicicletas y de 480 a 687 estaciones de bicicletas, y actualiza la tecnología y el diseño de bicicletas compartidas de la ciudad para que sean más fáciles de usar, todo a aproximadamente la mitad de los costos operativos del antiguo servicio. Otros departamentos han comenzado a replicar las estrategias de contratación abierta de Ecobici para importantes proyectos públicos estratégicos, y la ciudad también mejoró su sistema de contratación electrónica para ayudar a otros a utilizar el enfoque de **Ecobici para involucrar a proveedores, ciudadanos y organizaciones de la sociedad civil al principio de los procesos de contratación de alta prioridad. [Lea más sobre este estudio de caso aquí](https://www.open-contracting.org/es/2022/01/27/hacia-la-apertura-sobre-ruedas-el-recorrido-de-ciudad-de-mexico-para-contratar-un-mejor-sistema-de-bicicletas-publicas/).**
{% endcallout %}
