...
Par exemple, comme nous l’indiquons dans la section consacrée à certains secteurs, l’incidence environnementale du [secteur de la construction](https://sustainable.open-contracting.org/construction-sector-1) concerne principalement les émissions de CO2 et des effets potentiels sur les matières premières, la pollution et la biodiversité. Pour sa part, le [secteur des technologies de l’information et des communications](https://sustainable.open-contracting.org/ict-sector-1) est souvent associé aux déchets, aux substances dangereuses et à l’extraction de matières premières.
...
{% toggle **Les initiatives du marché local axées sur la durabilité** %}
...
Les politiques et réglementations sur la durabilité en vigueur doivent être considérées comme des variables pour définir des catégories de marchés prioritaires et il est nécessaire de privilégier celles qui possèdent déjà un cadre propice à la mise en place de marchés publics durables. La législation a été examinée durant le processus d’analyse de [l’environnement habilitant](https://sustainable.open-contracting.org/establish-an-enabling-environment) et peut inclure, par exemple, des règlements sur la gestion des déchets toxiques ou des conventions fondamentales de l’Organisation internationale du Travail.
...
La première étape a consisté à dresser une liste préliminaire de catégories de marchés. Cette liste contenait tous les livrables couverts par les critères écologiques de [l’Union européenne](https://ec.europa.eu/environment/gpp/eu_gpp_criteria_en.htm). Plusieurs facteurs ont ensuite été pris en compte pour définir les catégories de marchés prioritaires, notamment l’existence de l’éco-étiquette nationale du Vietnam appelée [*Green Label*](https://www.env.go.jp/policy/hozen/green/kokusai_platform/2016symposium/03_Vietnam.pdf). Ensuite, une méthodologie de notation a été définie : les produits non certifiés sont exclus ; ceux possédant l’éco-étiquette nationale se voient attribuer deux points ; et ceux possédant une éco-étiquette internationale équivalente se voient attribuer un point.
