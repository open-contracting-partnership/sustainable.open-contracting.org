...
However, if this is not the case, then it can be set as a contract clause as a commitment by the supplier to improve supply chain management. See[ this section](/interagir-avec-le-march) for more information about different market engagement methods.<br>
