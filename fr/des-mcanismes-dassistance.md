...
Comme souligné au début de ce guide, les gouvernements devront modifier fondamentalement leurs pratiques d’achat et explorer les nouvelles technologies et solutions pour répondre à l’urgence climatique. L’interaction avec les parties prenantes, la circulation de l’information et l’évaluation des solutions seront essentielles pour cette transition, étant donné que les gouvernements ne savent pas encore toujours ce qu’ils peuvent acheter et comment s’y prendre.
...
Nous présentons ci-dessous certaines des meilleures façons d’y parvenir, la clé étant d’interagir de façon répétée et constante. Notre étude de cas sur le processus de renouvellement du [système de vélos en libre-service de la ville de Mexico](/base-de-donnes-dtudes-de-cas/utilisation-de-contrats-ouverts-pour-acqurir-un-systme-de-vlos-mexico) illustre bien cet aspect. En effet, en repensant son processus et en s’appuyant sur la participation constante des prestataires et des communautés, la ville a réussi à étendre son système de vélos en libre-service jusqu’à des quartiers plus pauvres et défavorisés, pour des résultats bien meilleurs que ceux des appels d’offres précédents.

En plus des appels d’offres particuliers, les marchés publics durables et ouverts nécessiteront des changements de politiques intelligents et fondés sur les données. Un leadership fort et l’approbation des acteurs du marché et des communautés seront nécessaires. Une fois de plus, l’interaction et les avis extérieurs seront déterminants pour favoriser le changement et l’obtention de résultats satisfaisants. Il existe de bons exemples illustrant la façon dont les organisations de la société civile effectuent un suivi des résultats des achats publics et des bénéfices pour la population en [Ukraine](https://www.open-contracting.org/2020/09/14/dozorro-a-network-of-citizen-corruption-fighters/)[, au Nigéria](https://medium.com/open-contracting-stories/open-it-to-fix-it-fb4e8fd616fc) et en [Inde](https://www.open-contracting.org/2022/04/06/using-data-analysis-to-spot-gaps-in-access-to-maternal-and-child-health-services/).

{% toggle **Ateliers de renforcement des capacités destinés aux services de passation de marchés** %}

L’organisation d’ateliers avec des membres de services de passation de marchés pour guider, étoffer et diffuser le [plan d’action](/plan-daction) définitif sera essentielle pour l’élaboration de ce dernier, la maximisation de ses bénéfices et sa reconnaissance.

De la même manière, vous avez tout intérêt à prévoir une interaction significative avec la communauté de fournisseurs afin de planifier et d’expliquer la façon dont les pratiques d’achat changeront dans les catégories de marchés prioritaires et afin de stimuler l’investissement au sein du marché. Il est essentiel de communiquer les avantages du plan et de renforcer la confiance vis-à-vis de sa mise en œuvre.

Des ateliers de formation sur les marchés publics durables peuvent être organisés durant l’année afin de renforcer les capacités des fournisseurs et de les rassurer en ce qui concerne la mise en place de ces marchés. Ces ateliers sont également une bonne occasion de diffuser les meilleures pratiques parmi les membres de la profession.

{% endtoggle %}

{% toggle **Ateliers sur la durabilité avec les fournisseurs** %}

Les pouvoirs publics doivent collaborer avec leurs fournisseurs et des organismes sectoriels afin de déterminer [les normes de durabilité qui doivent être intégrées aux processus de passation de marchés](/des-critres-de-durabilit)
...
Les fournisseurs présents dans ces catalogues et registres peuvent être sélectionnés selon certaines normes de durabilité définies par des programmes de certification environnementale ou vos critères normalisés. Un catalogue ou un registre de fournisseurs responsables aiderait à répondre aux préoccupations d’ordre juridique des services de passation de marchés, car il serait induit que le gouvernement encourage à acheter les produits ou services des fournisseurs qui s’y trouvent, et ce malgré des prix plus élevés. Il est important de créer des procédures claires et équitables permettant d’intégrer ce registre, en particulier pour les plus petites entreprises, et de le mettre à jour régulièrement.

Pour en savoir plus sur la création de registres de fournisseurs responsables à partir des données relatives à la commande publique, consultez [la possibilité 9 dans la troisième partie](/possibilits-dutilisation-des-donnes#option-9).
