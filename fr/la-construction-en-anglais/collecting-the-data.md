...
sidebar: true
---
Once the key sustainability variables [have been identified](/la-construction-en-anglais/selecting-your-data), it is important to determine how, and when, these will be collected throughout the project.
...
{% toggle **Quality control reports** %}
...
{% toggle **Material and waste registries**  %}
...
{% toggle **Civil society engagement** %}
...
All contracts should include a clear description of the data that will be collected, when it will be collected and the methods that will be used. Consequences and responsibilities [in case of non-compliance](/obligations-contractuelles) should also be included.
{% endcallout %}
