...
[Le Standard de données sur la commande publique ouverte](https://standard.open-contracting.org/latest/fr/schema/identifiers/) fournit des orientations concernant les identifiants qui peuvent être utilisés pour regrouper et croiser des données sur la commande publique.
